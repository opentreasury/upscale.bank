...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const UpscaleCoin::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const UpscaleCoin::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(UpscaleCoin::Block& blockTemplate) const {
