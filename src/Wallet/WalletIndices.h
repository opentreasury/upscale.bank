...
struct WalletRecord {
  ...
  UpscaleCoin::ITransfersContainer* container = nullptr;
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransfersContainerIndex>,
      BOOST_MULTI_INDEX_MEMBER(WalletRecord, UpscaleCoin::ITransfersContainer*, container) >
  >
> WalletsContainer;

struct UnlockTransactionJob {
  uint32_t blockHeight;
  UpscaleCoin::ITransfersContainer* container;
...
typedef boost::multi_index_container <
  UpscaleCoin::WalletTransaction,
  boost::multi_index::indexed_by <
    boost::multi_index::random_access < boost::multi_index::tag <RandomAccessIndex> >,
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransactionIndex>,
      boost::multi_index::member<UpscaleCoin::WalletTransaction, Crypto::Hash, &UpscaleCoin::WalletTransaction::hash >
    >,
    boost::multi_index::ordered_non_unique < boost::multi_index::tag <BlockHeightIndex>,
      boost::multi_index::member<UpscaleCoin::WalletTransaction, uint32_t, &UpscaleCoin::WalletTransaction::blockHeight >
    >
  >
> WalletTransactions;

typedef std::pair<size_t, UpscaleCoin::WalletTransfer> TransactionTransferPair;
typedef std::vector<TransactionTransferPair> WalletTransfers;
typedef std::map<size_t, UpscaleCoin::Transaction> UncommitedTransactions;
