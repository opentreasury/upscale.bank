...
namespace Tools
{
  ...
  /*                                                                      */
  /************************************************************************/
  class wallet_rpc_server : UpscaleCoin::HttpServer
  {
  public:
  ...
  private:
    ...
    virtual void processRequest(const UpscaleCoin::HttpRequest& request, UpscaleCoin::HttpResponse& response) override;
