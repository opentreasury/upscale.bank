...
inline std::error_code make_error_code(UpscaleCoin::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), UpscaleCoin::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<UpscaleCoin::error::WalletErrorCodes>: public true_type {};
