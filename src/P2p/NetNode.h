...
#include "UpscaleCoinCore/OnceInInterval.h"
...
namespace UpscaleCoin
{
  ...
  struct P2pConnectionContext : public UpscaleCoinConnectionContext {
  public:
    ...
    P2pConnectionContext(P2pConnectionContext&& ctx) : 
      UpscaleCoinConnectionContext(std::move(ctx)),
      context(ctx.context),
      peerId(ctx.peerId),
  ...
  public:
    ...
    NodeServer(System::Dispatcher& dispatcher, UpscaleCoin::UpscaleCoinProtocolHandler& payload_handler, Logging::ILogger& log);
    ...
    UpscaleCoin::UpscaleCoinProtocolHandler& get_payload_object();
    ...
    UpscaleCoin::PeerlistManager& getPeerlistManager() { return m_peerlist; }
  ...
  private:
    ...
    bool handshake(UpscaleCoin::LevinProtocol& proto, P2pConnectionContext& context, bool just_take_peerlist = false);
    bool timedSync();
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const UpscaleCoinConnectionContext& context) override;
    virtual void for_each_connection(std::function<void(UpscaleCoin::UpscaleCoinConnectionContext&, PeerIdType)> f) override;
    ...
    bool idle_worker();
    bool handle_remote_peerlist(const std::list<PeerlistEntry>& peerlist, time_t local_time, const UpscaleCoinConnectionContext& context);
    ...
    UpscaleCoinProtocolHandler& m_payload_handler;
