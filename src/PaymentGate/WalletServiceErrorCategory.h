...
inline std::error_code make_error_code(UpscaleCoin::error::WalletServiceErrorCode e) {
  return std::error_code(static_cast<int>(e), UpscaleCoin::error::WalletServiceErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<UpscaleCoin::error::WalletServiceErrorCode>: public true_type {};
