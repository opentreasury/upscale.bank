...
public:
  ...
  const UpscaleCoin::Currency getCurrency();
...
private:
  ...
  void runWalletService(const UpscaleCoin::Currency& currency, UpscaleCoin::INode& node);

  System::Dispatcher* dispatcher;
  System::Event* stopEvent;
  PaymentService::ConfigurationManager config;
  PaymentService::WalletService* service;
  UpscaleCoin::CurrencyBuilder currencyBuilder;
