...
public:
  ...
  bool serialize(UpscaleCoin::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const UpscaleCoin::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
