...
public:
  ...
  virtual void notify(Tools::ObserverManager<UpscaleCoin::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<UpscaleCoin::IWalletLegacyObserver>& observer) override
  {
