...
public:
  WalletLegacy(const UpscaleCoin::Currency& currency, INode& node);
...
private:
  ...
  UpscaleCoin::AccountBase m_account;
  ...
  Tools::ObserverManager<UpscaleCoin::IWalletLegacyObserver> m_observerManager;
