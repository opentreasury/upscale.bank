...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\UpscaleCoin_NAME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\UpscaleCoin_NAME
    // Mac: ~/Library/Application Support/UpscaleCoin_NAME
    // Unix: ~/.UpscaleCoin_NAME
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + UpscaleCoin::UpscaleCoin_NAME;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + UpscaleCoin::UpscaleCoin_NAME);
#else
    // Unix
    config_folder = (pathRet + "/." + UpscaleCoin::UpscaleCoin_NAME);
#endif
