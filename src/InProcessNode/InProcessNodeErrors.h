...
inline std::error_code make_error_code(UpscaleCoin::error::InProcessNodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), UpscaleCoin::error::InProcessNodeErrorCategory::INSTANCE);
}
