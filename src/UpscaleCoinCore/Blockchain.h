...
#include "UpscaleCoinCore/BlockIndex.h"
#include "UpscaleCoinCore/Checkpoints.h"
#include "UpscaleCoinCore/Currency.h"
#include "UpscaleCoinCore/IBlockchainStorageObserver.h"
#include "UpscaleCoinCore/ITransactionValidator.h"
#include "UpscaleCoinCore/SwappedVector.h"
...
#include "UpscaleCoinCore/MessageQueue.h"
#include "UpscaleCoinCore/BlockchainMessages.h"
#include "UpscaleCoinCore/IntrusiveLinkedList.h"
...
namespace UpscaleCoin {
  ...
  using UpscaleCoin::BlockInfo;
  class Blockchain : public UpscaleCoin::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with UpscaleCoinProtocolHandler.
  ...
  private:
    ...
    Blocks m_blocks;
    UpscaleCoin::BlockIndex m_blockIndex;
