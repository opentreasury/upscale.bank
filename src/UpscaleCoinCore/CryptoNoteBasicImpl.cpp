...
namespace UpscaleCoin {
  ...
  //-----------------------------------------------------------------------
  bool operator ==(const UpscaleCoin::Transaction& a, const UpscaleCoin::Transaction& b) {
    return getObjectHash(a) == getObjectHash(b);
  }
  //-----------------------------------------------------------------------
  bool operator ==(const UpscaleCoin::Block& a, const UpscaleCoin::Block& b) {
    return UpscaleCoin::get_block_hash(a) == UpscaleCoin::get_block_hash(b);
  }
}
