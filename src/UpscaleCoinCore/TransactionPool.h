...
#include "UpscaleCoinCore/ITimeProvider.h"
#include "UpscaleCoinCore/ITransactionValidator.h"
#include "UpscaleCoinCore/ITxPoolObserver.h"
...
namespace UpscaleCoin {
  ...
  public:
    OnceInTimeInterval(unsigned interval, UpscaleCoin::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    UpscaleCoin::ITimeProvider& m_timeProvider;
  };
  ...
  public:
    tx_memory_pool(
      ...
      UpscaleCoin::ITransactionValidator& validator,
      UpscaleCoin::ITimeProvider& timeProvider,
      Logging::ILogger& log);
  ...
  private:
    ...
    UpscaleCoin::ITransactionValidator& m_validator;
    UpscaleCoin::ITimeProvider& m_timeProvider;
