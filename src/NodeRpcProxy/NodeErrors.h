...
inline std::error_code make_error_code(UpscaleCoin::error::NodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), UpscaleCoin::error::NodeErrorCategory::INSTANCE);
}
