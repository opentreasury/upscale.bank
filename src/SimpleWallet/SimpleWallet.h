...
namespace UpscaleCoin
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public UpscaleCoin::INodeObserver, public UpscaleCoin::IWalletLegacyObserver, public UpscaleCoin::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const UpscaleCoin::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(UpscaleCoin::simple_wallet& simple_wallet)
    ...
    private:
      UpscaleCoin::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<UpscaleCoin::NodeRpcProxy> m_node;
    std::unique_ptr<UpscaleCoin::IWalletLegacy> m_wallet;
