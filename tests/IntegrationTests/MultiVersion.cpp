...
public:
  ...
  MultiVersionTest(const UpscaleCoin::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    UpscaleCoin::AccountBase stashAddress;
