...
public:
  ...
  bool check_balances_1(UpscaleCoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_balances_2(UpscaleCoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
