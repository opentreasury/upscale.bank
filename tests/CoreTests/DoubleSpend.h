...
public:
  ...
  bool mark_invalid_tx(UpscaleCoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(UpscaleCoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(UpscaleCoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  UpscaleCoin::Block m_last_valid_block;
...
protected:
  ...
  UpscaleCoin::AccountBase m_bob_account;
  UpscaleCoin::AccountBase m_alice_account;
  UpscaleCoin::KeyPair m_outputTxKey;
