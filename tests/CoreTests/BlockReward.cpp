...
bool gen_block_reward::check_block_verification_context(const UpscaleCoin::block_verification_context& bvc, size_t event_idx, const UpscaleCoin::Block& /*blk*/)
{
...
bool gen_block_reward::mark_invalid_block(UpscaleCoin::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
  m_invalid_block_index = ev_index + 1;
  return true;
}

bool gen_block_reward::mark_checked_block(UpscaleCoin::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
  m_checked_blocks_indices.push_back(ev_index - 1);
  return true;
}

bool gen_block_reward::check_block_rewards(UpscaleCoin::core& /*c*/, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
