...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_tx_verification_context(const UpscaleCoin::tx_verification_context& tvc, bool tx_added, size_t event_idx, const UpscaleCoin::Transaction& /*tx*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_block_verification_context(const UpscaleCoin::block_verification_context& bvc, size_t event_idx, const UpscaleCoin::Block& /*block*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_last_valid_block(UpscaleCoin::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
{
  std::list<UpscaleCoin::Block> block_list;
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_tx(UpscaleCoin::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_block(UpscaleCoin::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_double_spend(UpscaleCoin::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
  ...
  UpscaleCoin::AccountBase bob_account = boost::get<UpscaleCoin::AccountBase>(events[1]);
  UpscaleCoin::AccountBase alice_account = boost::get<UpscaleCoin::AccountBase>(events[2]);

  std::vector<UpscaleCoin::Block> chain;
  map_hash2tx_t mtx;
  std::vector<UpscaleCoin::Block> blocks(block_list.begin(), block_list.end());
...
bool gen_double_spend_in_tx<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  UpscaleCoin::TransactionSourceEntry se;
  se.amount = tx_0.outputs[0].amount;
  se.outputs.push_back(std::make_pair(0, boost::get<UpscaleCoin::KeyOutput>(tx_0.outputs[0].target).key));
  se.realOutput = 0;
  se.realTransactionPublicKey = UpscaleCoin::getTransactionPublicKeyFromExtra(tx_0.extra);
  se.realOutputIndexInTransaction = 0;
  sources.push_back(se);
  // Double spend!
  sources.push_back(se);

  UpscaleCoin::TransactionDestinationEntry de;
...
bool gen_double_spend_in_the_same_block<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  UpscaleCoin::Transaction tx_1 = txs_1.front();
