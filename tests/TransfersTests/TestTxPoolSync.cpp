...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<UpscaleCoin::INode> node0;
    std::unique_ptr<UpscaleCoin::INode> node1;
    std::unique_ptr<UpscaleCoin::INode> node2;
    std::unique_ptr<UpscaleCoin::INode> node3;
    ...
    std::vector<std::unique_ptr<UpscaleCoin::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<UpscaleCoin::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<UpscaleCoin::INode> node2;
    std::unique_ptr<UpscaleCoin::INode> node3;
    std::unique_ptr<UpscaleCoin::INode> node4;
    ...
    std::vector<std::unique_ptr<UpscaleCoin::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<UpscaleCoin::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<UpscaleCoin::ITransactionReader>> poolTxs4;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterSwitchingToAlternativeChain) {
    ...
    UpscaleCoin::Block blockTemplate2;
