...
class TestWalletLegacy : private UpscaleCoin::IWalletLegacyObserver {
public:
  TestWalletLegacy(System::Dispatcher& dispatcher, const UpscaleCoin::Currency& currency, UpscaleCoin::INode& node);
  ~TestWalletLegacy();
  ...
  UpscaleCoin::IWalletLegacy* wallet();
  UpscaleCoin::AccountPublicAddress address() const;
...
private:
  ...
  std::unique_ptr<UpscaleCoin::IWalletLegacyObserver> m_walletObserver;
